...
ranz.sendMessage(from, {video:{url:buffer}, mimetype:"video/mp4", caption:"Success"}, {quoted:hw})
break
//=================================================//
case 'asupanukhty':
case 'asupan-ukhty':
...
ranz.sendMessage(from, {video:{url:buffer}, mimetype:"video/mp4", caption:"Ini Kak Jangan Lupa Donasi Ya:)"}, {quoted:hw})
break
//=================================================//
case 'asupan-santuy':
case 'asupansantuy':
...
ranz.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:hw})
break
//=================================================//
case 'cecan-indo':
teks = `nih Kak >\\<`
